// let canvas = document.getElementById("hotMap");

// let pencil = canvas.getContext("2d");

// var background = new Image();
// background.src = "../assets/img/png-clipart-house.jpg";

// background.onload = function () {
//   canvas.width = background.width;
//   canvas.height = background.height;

//   pencil.drawImage(background, 0, 0);

//   strokeCircle(pencil, 400, 150, 30, 0.8);
//   strokeCircle(pencil, 100, 100, 30, 0.3);
//   strokeCircle(pencil, 200, 200, 30, 0.6);

//   strokeCircle(pencil, 600, 200, 30, 0.7);

//   strokeCircle(pencil, 700, 300, 30, 1);
// };

// function strokeCircle(ctx, midx, midy, radius, opacity) {
//   ctx.beginPath();
//   ctx.moveTo(midx + radius, midy);
//   ctx.arc(midx, midy, radius, 0, 2 * Math.PI, false);
//   ctx.fillStyle = "rgba(232, 21, 0," + opacity + ")";
//   ctx.fill();
// }
...
var infoMap = document.getElementById("map");

var points = [];
var max = 0;
var width = infoMap.width;
var height = infoMap.height;
var len = 70;
...
while (len--) {
  ...
  let vx = Math.floor(Math.random() * width);
  let vy = Math.floor(Math.random() * height);
